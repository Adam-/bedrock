...
extern compression_buffer *compression_compress_init(bedrock_memory_pool *pool, size_t buffer_size);
...
extern compression_buffer *compression_decompress_init(bedrock_memory_pool *pool, size_t buffer_size);
...
extern compression_buffer *compression_compress(bedrock_memory_pool *pool, size_t buffer_size, const unsigned char *data, size_t len);
extern compression_buffer *compression_decompress(bedrock_memory_pool *pool, size_t buffer_size, const unsigned char *data, size_t len);
