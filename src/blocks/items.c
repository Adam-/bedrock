...
struct bedrock_item bedrock_items[] = {
	...
	{ITEM_DIAMOND_SWORD,      "Diamond sword",      ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_SWORD   | ITEM_FLAG_DIAMOND | ITEM_FLAG_GOLD  | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_DIAMOND_SHOVEL,     "Diamond shovel",     ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_SHOVEL  | ITEM_FLAG_DIAMOND | ITEM_FLAG_GOLD  | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_DIAMOND_PICKAXE,    "Diamond pickaxe",    ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_PICKAXE | ITEM_FLAG_DIAMOND | ITEM_FLAG_GOLD  | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_DIAMOND_AXE,        "Diamond axe",        ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_AXE     | ITEM_FLAG_DIAMOND | ITEM_FLAG_GOLD  | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_GOLD_SWORD,         "Gold sword",         ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_SWORD   | ITEM_FLAG_GOLD    | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_GOLD_SHOVEL,        "Gold shovel",        ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_SHOVEL  | ITEM_FLAG_GOLD    | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_GOLD_PICKAXE,       "Gold pickaxe",       ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_PICKAXE | ITEM_FLAG_GOLD    | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_GOLD_AXE,           "Gold axe",           ITEM_FLAG_DAMAGABLE | ITEM_FLAG_ENCHANTABLE | ITEM_FLAG_AXE     | ITEM_FLAG_GOLD    | ITEM_FLAG_IRON  | ITEM_FLAG_STONE | ITEM_FLAG_WOOD},
	{ITEM_WOODEN_HOE,         "Wooden hoe",         ITEM_FLAG_DAMAGABLE | ITEM_FLAG_HOE         | ITEM_FLAG_WOOD},
	{ITEM_STONE_HOE,          "Stone hoe",          ITEM_FLAG_DAMAGABLE | ITEM_FLAG_HOE         | ITEM_FLAG_STONE},
	{ITEM_IRON_HOE,           "Iron hoe",           ITEM_FLAG_DAMAGABLE | ITEM_FLAG_HOE         | ITEM_FLAG_IRON},
	{ITEM_DIAMOND_HOE,        "Diamond hoe",        ITEM_FLAG_DAMAGABLE | ITEM_FLAG_HOE         | ITEM_FLAG_DIAMOND},
	{ITEM_GOLD_HOE,           "Gold hoe",           ITEM_FLAG_DAMAGABLE | ITEM_FLAG_HOE         | ITEM_FLAG_GOLD},
